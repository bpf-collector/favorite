...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/css/sign-up-login.css">
    <link rel="stylesheet" type="text/css" href="http://cdn.bootcss.com/font-awesome/4.6.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="${ctx}/css/inputEffect.css"/>
    <link rel="stylesheet" href="${ctx}/css/tooltips.css"/>
    <link rel="stylesheet" href="${ctx}/css/spop.min.css"/>

    <script src="${ctx}/js/jquery.min.js"></script>
    <script src="${ctx}/js/snow.js"></script>
    <script src="${ctx}/js/jquery.pure.tooltips.js"></script>
    <script src="${ctx}/js/spop.min.js"></script>
    ...
    <style type="text/css">
        ...
        body {
            ...
            background-image: url(${ctx}/images/snow.jpg);
